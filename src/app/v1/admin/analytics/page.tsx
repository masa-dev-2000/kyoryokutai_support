  ...
  return (
    <div>
      <header className="border-b bg-card px-8 py-5">
        <h1 className="text-xl font-bold">活動サマリー</h1>
            ...
            <CardContent>
              <div className="flex h-40 items-end gap-4">
                {trendWeeks.map((w) => (
                  ...
                  >
                    <div className="text-[11px] font-semibold">{w.posts}</div>
                    <div
                ...
                {topTags.map((t) => (
                  <div key={t.name}>
                    <div className="flex justify-between text-xs">
                      <span>{t.name}</span>
                      <span className="font-semibold">{t.count} 件</span>
                    </div>
                    <Progress
                      value={(t.count / topTags[0].count) * 100}
            ...
            <tbody className="divide-y">
              {regionActivity.map((r, i) => (
                <tr key={r.name} className="hover:bg-muted/40">
                  ...
                  <td className="px-5 py-2.5">{r.active}</td>
                  <td className="px-5 py-2.5">{r.posts}</td>
