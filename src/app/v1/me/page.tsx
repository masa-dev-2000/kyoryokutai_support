...
export default function MemberHomePage() {
  ...
  return (
    <div className="flex flex-col gap-5 px-5 pb-6 pt-5">
      ...
      {/* Primary CTA */}
      <Link href="/v1/me/logs/new" className="block">
      ...
      <section>
        ...
        <div className="grid grid-cols-2 gap-3">
          <Link href="/v1/me/assistant" className="block">
          ...
          <Link href="/v1/me/cases" className="block">
          ...
          <Link href="/v1/me/projects" className="block">
            <Card className="h-full">
              <CardContent className="flex h-full flex-col py-3">
                <div className="flex items-center gap-1.5">
          ...
          <Link href="/v1/me/events" className="block">
            <Card className="h-full">
              <CardContent className="flex h-full flex-col py-3">
                <div className="flex items-center gap-1.5">
      ...
      <section>
        ...
        <div className="space-y-3">
          <Link href={`/v1/me/reports/${report.yearMonth}` as Route}>
            <Card>
              <CardContent className="flex items-center justify-between">
