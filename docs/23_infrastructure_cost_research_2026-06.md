...
## LGWAN 対応(2026-06-14 追記、ADR-019 根拠)

### 4 つの方式の比較

| 方式 | 概要 | 自治体側コスト | SaaS 側コスト | 採用判断 |
|---|---|---|---|---|
| **A. α' モデル**(令和 6 年 10 月正式化) | LGWAN 接続系 PC から中間 FW 経由でホワイトリスト SaaS にローカルブレイクアウト | 中間 FW 既導入なら ¥0、未導入なら初期 500-2,000 万 + 年保守 100-300 万 | **¥0**(FQDN 追加のみ) | Year 2-3 標準 |
| **B. β / β' モデル** | 自治体側で業務系をインターネット接続系に移す(都道府県 3 割・政令市 4 割が採用) | 自治体次第 | ¥0 | β' 自治体なら何もしなくていい |
| **C. LGWAN-ASP 自前取得** | J-LIS 認定 + 専用線で LGWAN 内に SaaS を置く | 0(自治体は LGWAN 経由) | **初期 400-1,000 万 + 月 45-115 万** | **終生回避**(ADR-019) |
| **C'. LGWAN-ASP OEM 提携** | moconavi / 両備の既存ゲートウェイに乗る | 0 | 初期 100-300 万 + 売上 20-30% シェア | **Year 3+ の現実解** |

### J-LIS 接続料(2025-07-01 改定、参考)
- 100Mbps: 年 ¥462,000 / 月 ¥38,500
- 1Gbps: 年 ¥28,710,000 / 月 ¥2,392,500
- ※ J-LIS 接続料自体は安いが、ホスティング事業者経由必須で総額が膨らむ

### LGWAN-ASP 自前取得の実コスト試算
| 規模 | 初期費用 | 月額(運用) | 年間総額 | 1 自治体あたり吸収単価 |
|---|---|---|---|---|
| 1 自治体 | 500-1,000 万 | 50-100 万 | 600-1,200 万 | 600-1,200 万/年 |
| 10 自治体 | 同上 | 80-150 万 | 960-1,800 万 | 96-180 万/年 |
| 50 自治体 | 1,000-2,000 万 | 150-300 万 | 1,800-3,600 万 | 36-72 万/年 |
| **OEM(両備等経由)** | **100-300 万** | **売上の 20-30% シェア** | 売上連動 | 単価維持しやすい |

### 段階的対応戦略(ADR-019)
- **Phase 1(Year 1-2):** LGWAN 対応 ¥0、インターネット系で緩い〜標準自治体を狙う
- **Phase 2(Year 2 後半〜):** α' モデル対応(FW ホワイトリスト追加依頼)+ ISMAP-LIU 検討(ARR 2,000 万超で着手)
- **Phase 3(Year 3+、ARR 3,000 万超):** moconavi / 両備と OEM 提携、自前取得は終生回避

### 2024-2026 の構造変化(追い風)
1. デジタル庁が三層分離廃止 → ゼロトラスト移行方針(2024-05)
2. LGWAN 第 5 世代 + LGCS で**ガバクラ上の SaaS は LGWAN からシームレス**になる方向
3. 令和 7 年 4 月の少額随契緩和(委託 200 万円まで)= 随契調達可能 = 協力隊 SaaS に最大の追い風

### LGWAN 関連の出典
- [J-LIS LGWAN-ASP について](https://www.j-lis.go.jp/lgwan/asp/cms_15041.html)
- [J-LIS 接続料金 R7.7.1 PDF](https://j-lis.go.jp/file.jsp?%2Ffile%2FG-1-1-6_%E7%B7%8F%E5%90%88%E8%A1%8C%E6%94%BF%E3%83%8D%E3%83%83%E3%83%88%E3%83%AF%E3%83%BC%E3%82%AFASP%E6%8E%A5%E7%B6%9A%E6%96%99%E9%87%91_20250701.pdf=)
- [総務省 ガイドライン改定 R6.10](https://public-comment.e-gov.go.jp/pcm/1040?CLASSNAME=PCM1040&id=145210364&Mode=1)
- [総務省 β' モデル移行手順書](https://www.soumu.go.jp/main_content/000944507.pdf)
- [A10 α' モデル解説](https://www.a10networks.co.jp/news/blog/GuidelineforLocalGovernment2025.html)
- [両備 R-Cloud Proxy for kintone(2019)](https://www.ryobi.co.jp/news/20190717)
- [レコモット moconavi LGWAN クラウドゲートウェイ](https://prtimes.jp/main/html/rd/p/000000075.000018768.html)
- [デジタル庁 R7 国・地方ネットワーク検証事業](https://www.digital.go.jp/assets/contents/node/basic_page/field_ref_resources/3fcb7ad0-50b3-4abe-b2ab-de16ab1488b3/9bd35a6f/20251226_resources_network_overview_01.pdf)
- [Cybereason 三層分離廃止/ゼロトラスト](https://www.cybereason.co.jp/blog/security/12271/)
